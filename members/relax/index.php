...
<span><u>活動内容</u><br/>最短ルートではなく、贅沢さ・心地よさを基準に道を選ぶ。<br/>初めて訪れた場所でもリラックスし、優雅に過ごすことを心がける。</span></h1>
<h1 class="DiaPro"><span><u>応用編</u><br/>スマホを持たずに行動し、積極的に迷子になる。<br/>本格的に迷ったら寄り道はせず、来た道を戻る。<br/>（または、帰りたい方向を人に尋ねたり掲示板や地図を探す。）</span></h1>
</div>
<div id="announce">
<div class="greeting">
<h1 class="DiaPro">行ったことのない場所を「贅沢度・リラックス度」を基準に評価し、優雅にリラックスできるスポットのコレクションを制作しています。</h1>
